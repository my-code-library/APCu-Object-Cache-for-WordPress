...
//
// 1. Disable APCu inside WP-CLI (prevents recursion + memory exhaustion)
//
...
//
// 2. APCu available? If not, fallback to no-op cache
//
if (!function_exists('apcu_fetch')) {
    ...
    function wp_cache_flush(){return false;}
    function wp_cache_replace($k,$d,$g='',$e=0){return false;}
    function wp_cache_incr($k,$o=1,$g=''){return false;}
    function wp_cache_decr($k,$o=1,$g=''){return false;}
    function wp_cache_close(){}
    function wp_cache_add_global_groups($g){}
    function wp_cache_add_non_persistent_groups($g){}
    function wp_cache_switch_to_blog($id){}
    function wp_cache_reset(){}
    function wp_cache_get_multi($groups){return array();}
    return;
}

//
// 3. APCu cache with recursion guard + in-memory runtime cache
//
